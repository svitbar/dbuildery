...
@startuml
    ...
    |Користувач|
    : Вводить назву, опис та дедлайн нового завдання;
    note right #ffaaaa
    <b> Можливо
...
@startuml    
    ...
    |Користувач|
    : Вводить нові дані - назву, опис, дедлайн;
    note right #ffaaaa
    <b> Можливо
...
@startuml
    ...
    |Користувач|
        :Вводить логін або електронну адресу учасника;
        note right #ffaaaa
        <b> Можливо
...
**Передумови:** 
1. Користувач є учасником проєкту
2. Користувач увійшов в систему 
3. Користувач є замовником
...
@startuml
    ...
    |Користувач|
        :Натискає на учасника правою клавішою миші і 
...
*CreateAttachment_EX_MaxReached* - Користувач намагається створити нове вкладення, коли блок вкладень вікна завдання досяг максимальної кількості вкладень (255)
...
@startuml
    ...
    |Користувач|
    start
    : Відкриває вікно завдання;

    |Користувач|
    : Натискає кнопку "Створити вкладення"\n у блоці вкладень;
    note right #ffaaaa
    <b> Можливо
    <b> CreateAttachment_EX_MaxReached
    end note
    
    |Система|
    : Відкриває вікно створення нового вкладення;
    
    |Користувач|
    : Вводить назву та опис нового вкладення;
    note right #ffaaaa
    <b> Можливо
    <b> CreateAttachment_EX_Canceled
    end note 
        
    |Користувач|
    : Натискає кнопку "Підтвердити"\n у вікні створення нового вкладення;
    note right #ffaaaa
    <b> Можливо
    <b> CreateAttachment_EX_WrongName
    <b> CreteAttachment_EX_WrongLink
    end note
    
    |Система|
    : Створює вкладення з назвою та посиланням, що ввів\n користувач, у блоці вкладень вікна завдання;
    ...
    |Система|
    : Відображає нове вкладення з назвою та посиланням,\n що ввів користувач, у вікні завдання;
    stop;
...
*Мал. 19.* Сценарій використання - створення вкладення
...
@startuml
    ...
    |Користувач|
    : Натискає правою клавішею миші на\n вкладення, що хоче відредагувати;
    ...
    note right #ffaaaa
    <b> Можливо
    <b> EditAttachment_EX_NoPermission
    end note
        
    |Система|
    : Відкриває форму для редагування вкладення;
        
    |Користувач|
    : Вводить нові дані - назву, посилання;
    note right #ffaaaa
    <b> Можливо
    <b> EditAttachment_EX_Canceled
    end note
    ...
    note right #ffaaaa
    <b> Можливо
    <b> EditAttachment_EX_WrongName
    <b> EditAttachment_EX_NoChanges
    end note
    
    |Система|
    : Редагує вкладення відповідно до нових\n даних, які ввів користувач;
    
    |Система|
    : Сповіщає про успішне редагування вкладення;
    
    |Користувач|
    : Отримує сповіщення про успішне редагування вкладення;
    
    |Система|
    : Відображає вкладення з новими даними, які ввів\n користувач, у вікні завдання;
    stop;
...
*Мал. 20.* Сценарій використання - редагування існуючого вкладення
...
@startuml
    ...
    |Користувач|
    : Натискає правою клавішею миші на\n вкладення, що хоче видалити;
    
    |Користувач|
    : Обирає з випадаючого списку пункт "Видалити вкладення";
    
    |Система|
    : Перевіряє права користувача;
    note right #ffaaaa
    <b> Можливо
    <b> RemoveAttachment_EX_NoRights
    end note
    ...
    note right #ffaaaa
    <b> Можливо
    <b> RemoveAttachment_EX_Canceled
    end note
    ...
    |Система|
    : Перестає відображати вкладення,\n яке видалила;
    stop;
...
*Мал. 21.* Сценарій використання - видалення існуючого вкладення
