...
Користувачі можуть мати різні [ролі](#role) в проєкті, та виконувати різні дії відповідно до них. Коли [користувач](#user) створює проєкт, йому автоматично надається [роль](#role), що визначає максимальні [права](#grant).
