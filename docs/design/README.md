...
Користувачі можуть мати різні [ролі](#role) в проєкті, та виконувати різні дії відповідно до них. Коли [користувач](#user) створює проєкт, йому автоматично надається роль "Замовник" та права відповідно до цієї ролі.
